-- First update existing data to match new naming convention
UPDATE public.essays 
SET post_type = 'spark' 
WHERE post_type = 'short-insight';

UPDATE public.essays 
SET post_type = 'ignite' 
WHERE post_type = 'long-form';

-- Now update the constraint to support new post types: 'spark' and 'ignite'
